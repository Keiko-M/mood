...
function processMatch($label1, $label2, $label3, $label4) {
    ...
    for ($i = 0; $i < count($programmes); $i++) {
        ...
        $mathlevel = checkMatch($movieLabel1, $movieLabel2, $movieLabel3, $movieLabel4, $label1, $label2, $label3, $label4);
        arrayForMatchLevel($mathlevel);
    }
}
...
function arrayForMatchLevel($matchResult) {
    global $fourMatch;
    global $threeMatch;
    global $twoMatch;
    global $oneMatch;
